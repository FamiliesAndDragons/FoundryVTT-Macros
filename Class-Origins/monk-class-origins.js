...
const iChoseThisClassTable = await fromUuid('Compendium.world.class-origins.RollTable.7lABQOkCwzg5hOZJ');
const reason1Table = await fromUuid('Compendium.world.class-origins.RollTable.3jMsxObTcaOFOe9A');
const reason2Table = await fromUuid('Compendium.world.class-origins.RollTable.KI9ZMdCWMVO91Luo');
const reason3Table = await fromUuid('Compendium.world.class-origins.RollTable.qrVITyhRWDNgpasY');
...
await ChatMessage.create({
    ...
    • <b>Monastery:</b> ${reason1}<br>
    • <b>Monastic Icons:</b> ${reason2}<br>
    • <b>Master:</b> ${reason3}<br>
    <br>`,

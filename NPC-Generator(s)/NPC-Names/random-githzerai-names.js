...
// CHANGE CODE BELOW //
race = "Githzerai";
maleNameTable = await fromUuid('Compendium.world.roll-tables.RollTable.O79OlzYixcieddeX');
femaleNameTable = await fromUuid('Compendium.world.roll-tables.RollTable.JgE1h1eBrau2tMXI');
